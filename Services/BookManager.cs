...
namespace Services
{
    public class BookManager : IBookService
    {
        ...
        public async Task<(IEnumerable<BookDto> books, MetaData metaData)> GetAllBooksAsync(BookParameters bookPatameters, bool trackChanges)
        {
            var booksWithMetaData = await _manager.Book.GetAllBooksAsync(bookPatameters, trackChanges);
